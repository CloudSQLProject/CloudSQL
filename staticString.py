class StaticString:
    ...
    def __init__(self):
        ...
        self.LOGIN_AGAIN = "Failed, you have login, please logout first!"
        self.LOGIN_FIRST = "Failed, please login first!"
        self.USER_NOT_EXIST = "Failed, user not exists!"
        self.COMMAND_ERROR = "Failed, command error!"
        self.PASSWORD_WRONG = "Failed, the password is wrong!"
        self.DATABASE_EXIST = "Failed, database has existed!"
        self.ACCESS_DENIED = "Failed, permission is not enough!"
        self.NO_DATABASE_SELECT = "Failed, no database select!"
        self.TABLE_EXIST = "Failed, table has existed!"
        self.DATABASE_NOT_EXIST = "Failed, database not exists!"
        self.USER_EXIST = "Failed, user has exit!"
        self.TABLE_NOT_EXIST = "Failed, table not exists!"
        self.DATATYPE_NOT_MATCH = "Field, data type not match!"
        self.ATTR_NOT_EXIST = "Failed, attribute not exists!"
        self.DATA_EXIST = "Failed, data already exists!"
        self.COLUMN_NOT_EXIST = "Failed, column not exists!"
        self.PRIMARY_KEY_LIMIT_NOT_MATCH = "Failed, not match primary key limit!"
        self.NOT_NULL_LIMIT_NOT_MATCH = "Failed, not match not null limit!"
        self.UNIQUE_LIMIT_NOT_MATCH = "Failed, not match unique limit!"
        self.VIEW_NOT_EXIST = "Failed, view not exit!"
        self.VIEW_EXIST = "Failed, view has exit!"
        self.REVOKE_USER_NOT_EXIST = "Failed, user not exists in permission table!"
        self.REVOKE_USER_PERMISSION_NOT_EXIST = "Failed, delete permissions that the user does not have!"
        self.INTERNAL_ERROR = "Sorry, internal error!"
